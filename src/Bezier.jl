...
bezier(p0 :: Vector, p1 :: Vector, p2 :: Vector;               range = 0:0.01:1) = map(t -> bezier(p0,p1,p2,t), range) |> rowtocolumn
bezier(p0 :: Vector, p1 :: Vector, p2 :: Vector, p3 :: Vector; range = 0:0.01:1) = map(t -> bezier(p0,p1,p2,p3,t), range) |> rowtocolumn
