<p align="center">
  <img width="300" height="300" src="https://raw.githubusercontent.com/onecalfman/Bezier.jl/main/assets/logo.svg">
</p>
...
```
![example plot](https://raw.githubusercontent.com/onecalfman/Bezier.jl/main/assets/example.svg)
...
```julia
  ...
  scatter!(m[1,:],m[2,:])
```
![example plot 2](https://raw.githubusercontent.com/onecalfman/Bezier.jl/main/assets/example2.svg)
